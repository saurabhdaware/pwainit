...
<html>
    <head>
        ...
        <style>
            :root{
                --theme:${(this.ans.color.toLowerCase() != '#ffffff')?this.ans.color:'#111111'};
            }
    ...
    <div style="position:relative;margin-top:100px;font-family:arial,Cursive;padding-left:100px;text-align:center;">
        ...
        <div style="opacity:.8;color:#333;">
            ...
            ${this.ans.features.includes('Push API')?`<br><b>Confused about setting PUSH API backend? Checkout example for furthur setup <br><a href="https://github.com/saurabhdaware/pwainit-node-pushapi">https://github.com/saurabhdaware/pwainit-node-pushapi</a></b>
...
`
    ...
    const publicVapidKey = 'Your Public Vapid Key';  // Checkout my github repository https://github.com/saurabhdaware/pwainit-node-pushapi for the backend setup code and generation of the vapid id.
